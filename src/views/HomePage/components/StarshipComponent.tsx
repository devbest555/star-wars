...
`
const StarshipComponent: React.FC<{
    data: StarshipProps[]
}> = ({
    data
}) => {
    ...
    const savedData = JSON.parse(window.localStorage.getItem(localStorageKeys.bookmark_starship));
    ...
    const handleBookmark = (e: any, i: number, item: any) => {
        ...
        setMark(temp)
        window.localStorage.setItem(localStorageKeys.bookmark_starship, JSON.stringify(mark));
    }
    return(
        <Container>
            <TableWrapper>
